...
from svm import SVM
from rl_model3 import DDPGAgent
...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if APP_TYPE == 1:
            self.agent = DDPGAgent(state_space_size=3, action_space_size=1)
    ...
    def flow_stats_reply_handler(self, ev):
        ...
        if flags == 0:
            ...
            if APP_TYPE == 1:
                ...
                self.agent.track_performance(reward, action)  # Track reward and action
    ...
    def _get_state(self, sfe, ssip, rfip):
        ...
        state = np.array([sfe_norm, ssip_norm, rfip_norm])
        return state
